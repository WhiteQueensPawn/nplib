...
seed_page = 'http://udacity.com/cs101x/index.html'
    ...
    try:
        if url == "http://xkcd.com/353":
            return '<?xml version="1.0" encoding="utf-8" ?><?xml-stylesheet href=' \
                   '"http://imgs.xkcd.com/s/c40a9f8.css" type="text/css" media="screen" ?>' \
                   '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" ' \
                   '"http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd"><html xmlns=' \
                   '"http://www.w3.org/1999/xhtml"> <head> <title>xkcd: Python</title>' \
                   ' <link rel="stylesheet" type="text/css" href="http://imgs.xkcd.com/s/c40a9f8.css"' \
                   ' media="screen" title="Default" /> <!--[if IE]><link rel="stylesheet" type="text/css"' \
                   ' href="http://imgs.xkcd.com/s/ecbbecc.css" media="screen" title="Default" />' \
                   '<![endif]--> <link rel="alternate" type="application/atom+xml" title="Atom 1.0"' \
                   ' href="/atom.xml" /> <link rel="alternate" type="application/rss+xml" title="RSS 2.0"' \
                   ' href="/rss.xml" /> <link rel="icon" href="http://imgs.xkcd.com/s/919f273.ico"' \
                   ' type="image/x-icon" /> <link rel="shortcut icon"' \
                   ' href="http://imgs.xkcd.com/s/919f273.ico" type="image/x-icon" />' \
                   ' </head> <print get_page(seed_page)body> <div id="container"> <div id="topContainer">' \
                   ' <div id="topLeft" class="dialog"> <div class="hd"><div class="c"></div></div>' \
                   ' <div class="bd"> <div class="c"> <div class="s">\t<ul> <li>' \
                   '<a href="http://xkcd.com/554"">Archive</a><br /></li>\t <li>' \
                   '<a href="http://blag.xkcd.com/">News/Blag</a><br /></li>' \
                   ' <li><a href="http://store.xkcd.com/">Store</a><br /></li>' \
                   ' <li><a href="/about/">About</a><br /></li> <li>' \
                   '<a href="http://forums.xkcd.com/">Forums</a><br /></li> </ul> </div> </div> </div>' \
                   ' <div class="ft"><div class="c"></div></div> </div> <div id="topRight" class="dialog">' \
                   ' <div class="hd"><div class="c"></div></div> <div class="bd"> <div class="c">' \
                   ' <div class="s"> <div id="topRightContainer"> <div id="logo"> <a href="/">' \
                   '<img src="http://imgs.xkcd.com/s/9be30a7.png" alt="xkcd.com logo" height="83"' \
                   ' width="185"/></a> <h2><br />A webcomic of romance,<br/> sarcasm, math, and language.' \
                   '</h2> <div class="clearleft"></div> <br />XKCD updates every Monday, Wednesday,' \
                   ' and Friday. </div> </div> </div> </div> </div> <div class="ft"><div class="c">' \
                   '</div></div> </div> </div> <div id="contentContainer"> <div id="middleContent"' \
                   ' class="dialog"> <div class="hd"><div class="c"></div></div> <div class="bd">' \
                   ' <div class="c"> <div class="s"><h1>Python</h1><br/><br /><div class="menuCont">' \
                   ' <ul> <li><a href="/1/">|&lt;</a></li> <li><a href="/352/" accesskey="p">&lt; Prev' \
                   '</a></li> <li><a href="http://dynamic.xkcd.com/random/comic/" id="rnd_btn_t">Random</a>' \
                   '</li> <li><a href="/354/" accesskey="n">Next &gt;</a></li> <li><a href="/">&gt;|</a>' \
                   '</li> </ul></div><br/><br/><img src="http://imgs.xkcd.com/comics/python.png"' \
                   ' title="I wrote 20 short programs in Python yesterday. It was wonderful. Perl,' \
                   ' Im leaving you." alt="Python" /><br/><br/><div class="menuCont"> <ul> <li>' \
                   '<a href="/1/">|&lt;</a></li> <li><a href="/352/" accesskey="p">&lt; Prev</a>' \
...
print get_next_target(get_page("http://xkcd.com/353"))
